...
This local copy preserves the source proof; the import path is adapted to
AppliedModelingLib.Foundations.Math.FixedPoint.Scarf.
-/
...
/-!
# AppliedModelingLib.Math.FixedPoint.Brouwer
