/-
Ported from gametheoryinlean/AppliedModelingLib, commit
cef01c709a7d238f076b45818f2ff2629518efe3 (Apache-2.0).
This local copy preserves the source proof; the only intended adaptation is
its placement under AppliedModelingLib.Foundations.Math.FixedPoint.
-/

/-
Copyright (c) 2026 AppliedModelingLib contributors. All rights reserved.
...
/-!
# AppliedModelingLib.Math.FixedPoint.Scarf
...
standard simplex (`AppliedModelingLib.Math.FixedPoint.Brouwer`).
