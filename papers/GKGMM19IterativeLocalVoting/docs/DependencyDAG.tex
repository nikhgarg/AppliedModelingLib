...
\node[dag_result, text width=5.8cm] (Proposition2) at (4.2,-16.4) {
  \textbf{Proposition 2} \\
  Feasible expected-$L^1$ minimizer convergence;\\
  ordinary medians on product domains
};
...
\node[dag_result, text width=7.6cm, minimum width=8.0cm] (PaperStatus) at (9.4,-25.2) {
  \textbf{Paper status} \\
  Formalized: selected results are proved;\\
  C1 repair: Proposition 2; source clarification: Theorem 3.
};
